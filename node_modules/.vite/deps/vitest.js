...
function printer(val, config2, indentation, depth, refs, hasCalledToJSON) {
  ...
  config2.outputLength += result.length;
  if (config2.outputLength > config2.maxOutputLength) {
    config2.maxDepth = 0;
  }
  return result;
}
...
function diff_cleanupMerge(diffs) {
  ...
  if (((_a = diffs.at(-1)) == null ? void 0 : _a[1]) === "") {
    diffs.pop();
  }
  let changes = false;
  pointer = 1;
...
var _lazyMatch = () => {
  var __lib__ = (() => {
    ...
    q(w, { default: () => re });
    var A = (r) => Array.isArray(r), d2 = (r) => typeof r == "function", Q = (r) => r.length === 0, W = (r) => typeof r == "number", K = (r) => typeof r == "object" && r !== null, X = (r) => r instanceof RegExp, b2 = (r) => typeof r == "string", h = (r) => r === void 0, Y = (r) => {
    ...
    }, i2 = (r, e) => A(r) ? er(r, e) : b2(r) ? ar(r, e) : nr(r, e), er = (r, e) => {
      const n = {};
      for (const a of r) {
    ...
    }, tr = (r, e) => C2(r, 0, 1), f = (r, e) => C2(r, 0, 1 / 0), x = (r, e) => {
      const n = r.map(v);
      return g(_(M((a) => {
    ...
    }, sr = i2(/^\*\*\/\*$/, ".*"), cr = i2(/^\*\*\/(\*)?([ a-zA-Z0-9._-]+)$/, (r, e, n) => `.*${e ? "" : "(?:^|/)"}${n.replaceAll(".", "\\.")}`), lr = i2(/^\*\*\/(\*)?([ a-zA-Z0-9._-]*)\{([ a-zA-Z0-9._-]+(?:,[ a-zA-Z0-9._-]+)*)\}$/, (r, e, n, a) => `.*${e ? "" : "(?:^|/)"}${n.replaceAll(".", "\\.")}(?:${a.replaceAll(",", "|").replaceAll(".", "\\.")})`), y2 = i2(/\\./, p), pr = i2(/[$.*+?^(){}[\]\|]/, (r) => `\\${r}`), vr = i2(/./, p), hr = i2(/^(?:!!)*!(.*)$/, (r, e) => `(?!^${L(e)}$).*?`), dr = i2(/^(!!)+/, ""), fr = l([hr, dr]), xr = i2(/\/(\*\*\/)+/, "(?:/.+/|/)"), gr = i2(/^(\*\*\/)+/, "(?:^|.*/)"), mr = i2(/\/(\*\*)$/, "(?:/.*|$)"), _r = i2(/\*\*/, ".*"), j = l([xr, gr, mr, _r]), Sr = i2(/\*\/(?!\*\*\/)/, "[^/]*/"), yr = i2(/\*/, "[^/]*"), N = l([Sr, yr]), k = i2("?", "[^/]"), $r = i2("[", p), wr = i2("]", p), Ar = i2(/[!^]/, "^/"), br = i2(/[a-z]-[a-z]|[0-9]-[0-9]/i, p), Cr = i2(/[$.*+?^(){}[\|]/, (r) => `\\${r}`), Mr = i2(/[^\]]/, p), Er = l([y2, Cr, br, Mr]), B2 = x([$r, tr(Ar), f(Er), wr]), Pr = i2("{", "(?:"), Or = i2("}", ")"), Rr = i2(/(\d+)\.\.(\d+)/, (r, e, n) => or(+e, +n, Math.min(e.length, n.length)).join("|")), zr = i2(/([a-z]+)\.\.([a-z]+)/, (r, e, n) => R(e, n).join("|")), jr = i2(/([A-Z]+)\.\.([A-Z]+)/, (r, e, n) => R(e.toLowerCase(), n.toLowerCase()).join("|").toUpperCase()), Nr = l([Rr, zr, jr]), I = x([Pr, Nr, Or]), kr = i2("{", "(?:"), Br = i2("}", ")"), Ir = i2(",", "|"), Fr = i2(/[$.*+?^(){[\]\|]/, (r) => `\\${r}`), Lr = i2(/[^}]/, p), Zr = E(() => F), Dr = l([j, N, k, B2, I, Zr, y2, Fr, Ir, Lr]), F = x([kr, f(Dr), Br]), Ur = f(l([sr, cr, lr, fr, j, N, k, B2, I, F, y2, pr, vr])), Vr = Ur, Gr = z(Vr), L = Gr, Tr = i2(/\\./, p), qr = i2(/./, p), Hr = i2(/\*\*\*+/, "*"), Jr = i2(/([^/{[(!])\*\*/, (r, e) => `${e}*`), Qr = i2(/(^|.)\*\*(?=[^*/)\]}])/, (r, e) => `${e}*`), Wr = f(l([Tr, Hr, Jr, Qr, qr])), Kr = Wr, Xr = z(Kr), Yr = Xr, $ = (r, e) => {
  ...
  parseUserFixtures(runner2, userFixtures, supportNonTest, registrations = new Map(this._registrations)) {
    ...
    Object.entries(userFixtures).forEach(([name, fn2]) => {
      ...
      if (Array.isArray(fn2) && fn2.length >= 2 && _TestFixtures.isFixtureOptions(fn2[1])) {
        ...
        value = options.injected ? ((_a = runner2.injectValue) == null ? void 0 : _a.call(runner2, name)) ?? fn2[0] : fn2[0];
      } else {
        value = fn2;
      }
...
function matchesTags(testTags) {
  ...
  const tagsFilter = ((_a = runner2._currentSpecification) == null ? void 0 : _a.testTagsFilter) ?? runner2.config.tagsFilter;
  if (!tagsFilter) {
    return true;
  }
...
function createSuite() {
  function suiteFn(name, factoryOrOptions, optionsOrFactory) {
    ...
    const shuffle2 = this.shuffle ?? options.shuffle ?? ((_a = currentSuite == null ? void 0 : currentSuite.options) == null ? void 0 : _a.shuffle) ?? (runner == null ? void 0 : runner.config.sequence.shuffle);
    if (shuffle2 != null) {
...
function withTimeout(fn2, timeout, isHook = false, stackTraceError, onTimeout) {
  ...
  const { setTimeout: setTimeout4, clearTimeout: clearTimeout4 } = getSafeTimers();
...
function waitNextTick() {
  const { setTimeout: setTimeout4 } = getSafeTimers();
  return new Promise((resolve4) => setTimeout4(resolve4, 0));
}
...
// node_modules/vitest/dist/chunks/benchmark.D0SlKNbZ.js
...
function createMockInstance(options = {}) {
  ...
  const mockLength = ((_a = mockImplementation || originalImplementation) == null ? void 0 : _a.length) ?? 0;
  ...
  mock.withImplementation = function withImplementation(implementation, callback) {
    ...
    if (typeof returnValue === "object" && typeof (returnValue == null ? void 0 : returnValue.then) === "function") {
  ...
  mock.mockRestore = function mockRestore() {
    mock.mockReset();
    return restore == null ? void 0 : restore();
  };
...
function createMock({ state, config: config2, name: mockName, prototypeState, prototypeConfig, keepMembersImplementation, mockImplementation, prototypeMembers = [] }) {
  ...
  const name = mockName || (original == null ? void 0 : original.name) || "Mock";
  const namedObject = { [name]: function(...args) {
    ...
    const implementation = config2.onceMockImplementations.shift() || config2.mockImplementation || (prototypeConfig == null ? void 0 : prototypeConfig.onceMockImplementations.shift()) || (prototypeConfig == null ? void 0 : prototypeConfig.mockImplementation) || original || function() {
    };
    let returnValue;
    let thrownValue;
    let didThrow = false;
      ...
      if (new.target) {
        ...
        for (const prop of prototypeMembers) {
          ...
          returnValue[prop] = createMockInstance({
            originalImplementation: keepMembersImplementation ? prototypeConfig2 == null ? void 0 : prototypeConfig2.mockOriginal : void 0,
...
function registerCalls(args, state, prototypeState) {
  ...
  prototypeState == null ? void 0 : prototypeState.calls.push(args);
}
function registerInvocationOrder(order, state, prototypeState) {
  state.invocationCallOrder.push(order);
  prototypeState == null ? void 0 : prototypeState.invocationCallOrder.push(order);
}
function registerResult(result, state, prototypeState) {
  state.results.push(result);
  prototypeState == null ? void 0 : prototypeState.results.push(result);
}
function registerSettledResult(result, state, prototypeState) {
  state.settledResults.push(result);
  prototypeState == null ? void 0 : prototypeState.settledResults.push(result);
}
function registerInstance(instance, state, prototypeState) {
  const instanceIndex = state.instances.push(instance);
  const instancePrototypeIndex = prototypeState == null ? void 0 : prototypeState.instances.push(instance);
...
function registerContext(context, state, prototypeState) {
  ...
  const contextPrototypeIndex = prototypeState == null ? void 0 : prototypeState.contexts.push(context);
...
var ObjectContaining = class extends AsymmetricMatcher3 {
  ...
  getProperties(obj) {
    return [...Object.keys(obj), ...Object.getOwnPropertySymbols(obj).filter((s) => {
      var _a;
      return (_a = Object.getOwnPropertyDescriptor(obj, s)) == null ? void 0 : _a.enumerable;
    })];
  }
...
var SchemaMatching = class extends AsymmetricMatcher3 {
  ...
  toAsymmetricMatcher() {
    ...
    const issues = ((_a = this.result) == null ? void 0 : _a.issues) || [];
    if (issues.length > 0) {
...
function getMatcherState(assertion, expect2) {
  ...
  const currentTestName = (task == null ? void 0 : task.fullTestName) ?? "";
  if ((task == null ? void 0 : task.type) !== "test") {
    task = void 0;
  }
  const matcherState = {
    ...getState(expect2),
...
function stripSnapshotIndentation(inlineSnapshot) {
  ...
  if (lines[0].trim() !== "" || ((_a = lines.at(-1)) == null ? void 0 : _a.trim()) !== "") {
    return inlineSnapshot;
  }
...
var SnapshotState = class _SnapshotState {
  ...
  match({ testId, testName: testName2, received, key, inlineSnapshot, isInline, error, rawSnapshot }) {
    ...
    const expectedTrimmed = rawSnapshot ? expected : expected == null ? void 0 : expected.trim();
...
var SnapshotClient = class {
  ...
  assert(options) {
    ...
    if (!pass) {
      throw createMismatchError(`Snapshot \`${key || "unknown"}\` mismatched`, snapshotState.expand, rawSnapshot ? actual : actual == null ? void 0 : actual.trim(), rawSnapshot ? expected : expected == null ? void 0 : expected.trim());
    }
  }
...
// node_modules/vitest/dist/chunks/test.CBQUpOM3.js
var unsupported = [
  "matchSnapshot",
  "toMatchSnapshot",
          ...
          try {
            while (true) {
              ...
              try {
                ...
                await (onSettled == null ? void 0 : onSettled({
                  assertion,
                  status: "pass"
                }));
                return output;
                ...
                await delay(interval, setTimeout4);
              }
            }
          } finally {
            clearTimeout4(timerId);
          }
        };
        let awaited = false;
        test5.onFinished ?? (test5.onFinished = []);
...
To automatically clean-up native timers, use \`shouldClearNativeTimers\`.`
    ...
    function createClock(start, loopLimit) {
      ...
      clock.setTimeout = function setTimeout4(func, timeout) {
      ...
      clock.clearTimeout = function clearTimeout4(timerId) {
...
function waitFor(callback, options = {}) {
  const { setTimeout: setTimeout4, setInterval: setInterval2, clearTimeout: clearTimeout4, clearInterval: clearInterval2 } = getSafeTimers();
  ...
  return new Promise((resolve4, reject) => {
    ...
    const onResolve = (result) => {
      if (timeoutId) clearTimeout4(timeoutId);
    ...
    timeoutId = setTimeout4(handleTimeout, timeout);
...
function waitUntil(callback, options = {}) {
  ...
  return new Promise((resolve4, reject) => {
    ...
    if (checkCallback() === true) return;
    timeoutId = setTimeout4(onReject, timeout);
    intervalId = setInterval2(checkCallback, interval);
  });
}
...
async function runBenchmarkSuite(suite2, runner2) {
  ...
  for (const task of suite2.tasks) {
    ...
    if ((_a = task.meta) == null ? void 0 : _a.benchmark) benchmarkGroup.push(task);
  ...
  if (benchmarkGroup.length) {
    ...
    const addBenchTaskListener = (task, benchmark) => {
      task.addEventListener("complete", (e) => {
        ...
        if (!((_a2 = runner2.config.benchmark) == null ? void 0 : _a2.includeSamples)) result.samples.length = 0;
    ...
    for (const benchmark of benchmarkGroup) {
      ...
      await task.warmup();
      tasks.push([await new Promise((resolve4) => setTimeout4(async () => {
...
var NodeBenchmarkRunner = class {
  constructor(config2) {
    __publicField(this, "moduleRunner");
    this.config = config2;
  }
  async importTinybench() {
    return await import("./dist-HCII4VWL.js");
  }
...
var TestRunner = class {
  constructor(config2) {
    __publicField(this, "snapshotClient", getSnapshotClient());
    __publicField(this, "workerState", getWorkerState());
    __publicField(this, "moduleRunner");
    __publicField(this, "cancelRun", false);
    __publicField(this, "assertionsErrors", /* @__PURE__ */ new WeakMap());
    __publicField(this, "pool", this.workerState.ctx.pool);
    __publicField(this, "_otel");
    __publicField(this, "viteEnvironment");
    __publicField(this, "viteModuleRunner");
    __publicField(this, "trace", (name, attributes, cb) => {
...
`;
        (_a = suite2.result).errors ?? (_a.errors = []);
  ...
  getImportDurations() {
    ...
    if (limit === 0) return {};
    const sortedEntries = [...((_a = this.workerState.moduleExecutionInfo) == null ? void 0 : _a.entries()) || []].sort(([, a], [, b2]) => b2.duration - a.duration).slice(0, limit);
...
__publicField(TestRunner, "createTaskCollector", createTaskCollector);
__publicField(TestRunner, "getCurrentSuite", getCurrentSuite);
__publicField(TestRunner, "getCurrentTest", getCurrentTest);
__publicField(TestRunner, "createChainable", createChainable);
__publicField(TestRunner, "getSuiteHooks", getHooks);
__publicField(TestRunner, "getTestFn", getFn);
__publicField(TestRunner, "setSuiteHooks", getHooks);
__publicField(TestRunner, "setTestFn", getFn);
__publicField(TestRunner, "matchesTags", matchesTags);
/**
* @deprecated
*/
__publicField(TestRunner, "getBenchFn", getBenchFn);
/**
* @deprecated
*/
__publicField(TestRunner, "getBenchOptions", getBenchOptions);
...
var EvaluatedModules = class {
  ...
  */
  getModuleSourceMapById(id) {
    ...
    let mapString = (_a = MODULE_RUNNER_SOURCEMAPPING_REGEXP.exec(mod.meta.code.slice(lastIndex))) == null ? void 0 : _a[1];
...
// node_modules/vitest/dist/chunks/index.Dkvtd-Ku.js
